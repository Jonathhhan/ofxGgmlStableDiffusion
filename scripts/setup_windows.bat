...
REM ---------------------------------------------------------------------------
REM setup_windows.bat - One-command setup for ofxGgmlStableDiffusion on Windows.
REM
...
:usage
echo setup_windows.bat - One-command setup for ofxGgmlStableDiffusion on Windows.
echo.
echo Usage:
