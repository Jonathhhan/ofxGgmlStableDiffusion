/// Unit tests for ofxGgmlStableDiffusionRealtimeSession pipeline logic.
///
/// These tests validate the queue mechanics, statistics, and lifecycle contracts
/// that the real-time pipeline must satisfy.  Because the full ofxGgmlStableDiffusion
...
// ---------------------------------------------------------------------------
// Rolling-average stats logic (mirrors ofxGgmlStableDiffusionRealtimeSession)
// ---------------------------------------------------------------------------
