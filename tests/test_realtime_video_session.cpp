...
static ofxGgmlStableDiffusionImageFrame makeFeedbackFrame() {
...
static bool testPreviewWithoutFeedback() {
	...
	const auto imageRequest = ofxGgmlStableDiffusionBuildRealtimeVideoImageRequest(
		settings,
		request,
		ofxGgmlStableDiffusionRealtimeVideoQuality::Preview,
		nullptr);

	ok &= expect(imageRequest.mode == ofxGgmlStableDiffusionImageMode::TextToImage,
...
static bool testFeedbackTurnsPreviewIntoImg2Img() {
	...
	ok &= expect(imageRequest.mode == ofxGgmlStableDiffusionImageMode::ImageToImage,
...
static bool testRefineUsesRefineBudget() {
	...
	const auto imageRequest = ofxGgmlStableDiffusionBuildRealtimeVideoImageRequest(
		settings,
		request,
		ofxGgmlStableDiffusionRealtimeVideoQuality::Refine,
		&feedback);
