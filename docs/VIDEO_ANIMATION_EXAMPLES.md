...
void ofApp::setupParameterAnimation() {
    ...
    ofxGgmlStableDiffusionKeyframe kf2(30);
    kf2.cfgScale = 7.0f;
    kf2.strength = 0.5f;
    ...
    ofxGgmlStableDiffusionKeyframe kf3(60);
    kf3.cfgScale = 12.0f;
    kf3.strength = 0.2f;
...
void ofApp::setupSeedSequence() {
    ...
    auto request = ofxGgmlStableDiffusionCreateSeedSequenceRequest(
        42,      // Starting seed
        100,     // 100 frames
...
void ofApp::setupCombinedAnimation() {
    ...
    request.animationSettings.promptInterpolationMode = ofxGgmlStableDiffusionInterpolationMode::Smooth;
    ...
    request.animationSettings.parameterInterpolationMode = ofxGgmlStableDiffusionInterpolationMode::EaseInOut;

    ofxGgmlStableDiffusionKeyframe kf1(0);
    kf1.cfgScale = 5.0f;
    kf1.strength = 0.7f;

    ofxGgmlStableDiffusionKeyframe kf2(50);
    kf2.cfgScale = 8.0f;
    kf2.strength = 0.4f;

    ofxGgmlStableDiffusionKeyframe kf3(100);
    kf3.cfgScale = 6.0f;
    kf3.strength = 0.6f;
...
void ofApp::printFrameParameters() {
    ...
    float strength = ofxGgmlStableDiffusionGetFrameStrength(request, 25);
...
void ofApp::exportVideoMetadata() {
    ...
    for (int i = 0; i < request.frameCount; ++i) {
        ofJson metadata = ofxGgmlStableDiffusionGenerateFrameMetadata(
            i,
            ofxGgmlStableDiffusionGetFramePrompt(request, i),
            request.negativePrompt,
            ofxGgmlStableDiffusionGetFrameCfgScale(request, i),
            ofxGgmlStableDiffusionGetFrameStrength(request, i),
            ofxGgmlStableDiffusionGetFrameSeed(request, i),
            request.width,
            request.height,
    ...
    ofxGgmlStableDiffusionExportVideoParametersJson(
...
void ofApp::compareInterpolationModes() {
    ...
    auto linearRequest = ofxGgmlStableDiffusionCreatePromptInterpolationRequest(
        keyframes, 30, 512, 512,
        ofxGgmlStableDiffusionInterpolationMode::Linear
    );

    // Smooth - gentle acceleration/deceleration (cosine)
    auto smoothRequest = ofxGgmlStableDiffusionCreatePromptInterpolationRequest(
        keyframes, 30, 512, 512,
        ofxGgmlStableDiffusionInterpolationMode::Smooth
    );

    // EaseIn - starts slow, accelerates
    auto easeInRequest = ofxGgmlStableDiffusionCreatePromptInterpolationRequest(
        keyframes, 30, 512, 512,
        ofxGgmlStableDiffusionInterpolationMode::EaseIn
    );

    // EaseOut - starts fast, decelerates
    auto easeOutRequest = ofxGgmlStableDiffusionCreatePromptInterpolationRequest(
        keyframes, 30, 512, 512,
        ofxGgmlStableDiffusionInterpolationMode::EaseOut
    );

    // EaseInOut - smooth S-curve
    auto easeInOutRequest = ofxGgmlStableDiffusionCreatePromptInterpolationRequest(
        keyframes, 30, 512, 512,
        ofxGgmlStableDiffusionInterpolationMode::EaseInOut
    );
}
