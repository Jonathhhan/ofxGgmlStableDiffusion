...
This document provides a comprehensive overview of all improvements made to the ofxGgmlStableDiffusion addon during the April 2026 improvement initiative. The work was organized into phases, with Phases 1, 2 (partial), and 3 (primary goal) successfully completed.
...
- **File**: `src/ofxGgmlStableDiffusion.cpp:919-930`
...
- **File**: `src/ofxGgmlStableDiffusionThread.h:23-54`
...
**3. Fixed Data Races**
- **Files**: `src/ofxGgmlStableDiffusion.h`, `src/ofxGgmlStableDiffusion.cpp`, `src/ofxGgmlStableDiffusionThread.cpp`
...
- **File**: `src/ofxGgmlStableDiffusion.cpp:1681-1840`
...
- **File**: `src/ofxGgmlStableDiffusion.h:31-238`
...
- **New File**: `src/core/ofxGgmlStableDiffusionLimits.h` (193 lines)
...
All accessible via `ofxGgmlStableDiffusionLimits` namespace.
...
### New Files (4)
1. `src/core/ofxGgmlStableDiffusionLimits.h` - Validation constants
...
### Modified Files (6)
1. `src/ofxGgmlStableDiffusion.h` - Thread safety docs, limits include
2. `src/ofxGgmlStableDiffusion.cpp` - Exception safety, validation updates
3. `src/ofxGgmlStableDiffusionThread.h` - Overflow protection
4. `src/ofxGgmlStableDiffusionThread.cpp` - Removed redundant checks
5. `src/core/ofxGgmlStableDiffusionNativeAdapter.h` - Documented const_cast
...
✅ Use constants from `ofxGgmlStableDiffusionLimits`
