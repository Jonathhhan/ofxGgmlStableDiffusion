...
#include "ofxGgmlStableDiffusionImageHelpers.h"
#include "ofxGgmlStableDiffusionRankingHelpers.h"
#include "../video/ofxGgmlStableDiffusionVideoAnimation.h"
...
inline const char* ofxGgmlStableDiffusionCacheModeName(sd_cache_mode_t mode) {
	switch (mode) {
...
struct ofxGgmlStableDiffusionError {
...
struct ofxGgmlStableDiffusionContextSettings {
...
struct ofxGgmlStableDiffusionLora {
	std::string path;
	float strength = 1.0f;
...
enum class ofxGgmlStableDiffusionModelFamily {
	Unknown = 0,
	SD1,
	SD2,
	SDXL,
...
struct ofxGgmlStableDiffusionCapabilities {
	...
	bool supportsImageMode(ofxGgmlStableDiffusionImageMode mode) const {
		switch (mode) {
		case ofxGgmlStableDiffusionImageMode::TextToImage: return textToImage;
...
struct ofxGgmlStableDiffusionImageRequest {
	ofxGgmlStableDiffusionImageMode mode = ofxGgmlStableDiffusionImageMode::TextToImage;
	ofxGgmlStableDiffusionImageSelectionMode selectionMode =
...
struct ofxGgmlStableDiffusionVideoRequest {
	sd_image_t initImage{0, 0, 0, nullptr};
	...
	ofxGgmlStableDiffusionVideoMode mode = ofxGgmlStableDiffusionVideoMode::Standard;
	sd_cache_params_t cache{};
	std::vector<ofxGgmlStableDiffusionLora> loras;
	ofxGgmlStableDiffusionVideoAnimationSettings animationSettings;
...
struct ofxGgmlStableDiffusionGenerationParameters {
	std::string prompt;
	std::string negativePrompt;
	float cfgScale = -1.0f;
	float strength = -1.0f;
...
struct ofxGgmlStableDiffusionImageFrame {
	ofPixels pixels;
	int index = 0;
	int sourceIndex = 0;
	int64_t seed = -1;
	ofxGgmlStableDiffusionGenerationParameters generation;
...
struct ofxGgmlStableDiffusionVideoClip {
	...
	const ofxGgmlStableDiffusionImageFrame * frameForTime(float seconds) const;
...
struct ofxGgmlStableDiffusionResult {
	bool success = false;
	ofxGgmlStableDiffusionTask task = ofxGgmlStableDiffusionTask::None;
	...
	std::string error;
	std::vector<ofxGgmlStableDiffusionImageFrame> images;
	ofxGgmlStableDiffusionVideoClip video;
