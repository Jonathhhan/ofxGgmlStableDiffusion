...
enum class ofxGgmlStableDiffusionRealtimeMode {
...
struct ofxGgmlStableDiffusionRealtimeSettings {
	ofxGgmlStableDiffusionRealtimeMode mode = ofxGgmlStableDiffusionRealtimeMode::Streaming;
...
struct ofxGgmlStableDiffusionRealtimeStats {
...
struct ofxGgmlStableDiffusionRealtimeRequest {
	std::string prompt;
...
using ofxSdRealtimeResultCallback = std::function<void(const ofxGgmlStableDiffusionResult&)>;
using ofxSdRealtimeLatencyCallback = std::function<void(float latencyMs)>;

/// Real-time generation session manager
class ofxGgmlStableDiffusionRealtimeSession {
public:
	...
	bool start(const ofxGgmlStableDiffusionRealtimeSettings& settings);
	...
	/// @return True if session started successfully
	bool start(const ofxGgmlStableDiffusionRealtimeSettings& settings, ofxGgmlStableDiffusion& sd);
	...
	/// Attach or detach the ofxGgmlStableDiffusion instance used for generation.
	...
	bool submit(const ofxGgmlStableDiffusionRealtimeRequest& request);
	...
	ofxGgmlStableDiffusionRealtimeStats getStats() const;

	/// Get current settings
	/// @return Session settings
	ofxGgmlStableDiffusionRealtimeSettings getSettings() const;
...
private:
	...
	ofxGgmlStableDiffusionRealtimeStats stats;
	ofxSdRealtimeResultCallback resultCallback;
	ofxSdRealtimeLatencyCallback latencyCallback;

	ofxGgmlStableDiffusionRealtimeRequest pendingRequest;
