...
namespace ofxGgmlStableDiffusionNativeAdapter {
...
inline std::string buildEffectivePrompt(const ofxGgmlStableDiffusionImageRequest& request) {
...
inline sd_img_gen_params_t buildImageParams(
	const ofxGgmlStableDiffusionThread::ImageTaskData& taskData,
	sd_ctx_t* sdCtx,
