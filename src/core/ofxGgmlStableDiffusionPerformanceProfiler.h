...
struct ofxGgmlStableDiffusionProfileEntry {
	std::string name;
...
struct ofxGgmlStableDiffusionPerformanceStats {
	std::map<std::string, ofxGgmlStableDiffusionProfileEntry> entries;
...
class ofxGgmlStableDiffusionScopedTimer {
public:
	ofxGgmlStableDiffusionScopedTimer(const std::string& name, ofxGgmlStableDiffusionProfileEntry& entry)
	...
	~ofxGgmlStableDiffusionScopedTimer() {
...
private:
	std::string name_;
	ofxGgmlStableDiffusionProfileEntry& entry_;
};

/// Performance profiler for tracking generation pipeline bottlenecks
class ofxGgmlStableDiffusionPerformanceProfiler {
public:
	ofxGgmlStableDiffusionPerformanceProfiler();
	~ofxGgmlStableDiffusionPerformanceProfiler();
	...
	ofxGgmlStableDiffusionScopedTimer scopedTimer(const std::string& name);

	/// Get current statistics
	ofxGgmlStableDiffusionPerformanceStats getStats() const;

	/// Get specific entry
	ofxGgmlStableDiffusionProfileEntry getEntry(const std::string& name) const;
...
private:
	std::map<std::string, ofxGgmlStableDiffusionProfileEntry> entries_;
