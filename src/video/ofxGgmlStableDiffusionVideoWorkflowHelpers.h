...
enum class ofxGgmlStableDiffusionVideoWorkflowPreset {
	FastPreview = 0,
	LowVram,
	Balanced,
	Quality,
...
struct ofxGgmlStableDiffusionVideoPromptValidation {
	bool ok = true;
	std::vector<std::string> errors;
	std::vector<std::string> warnings;
};

inline const char * ofxGgmlStableDiffusionVideoWorkflowPresetLabel(
	ofxGgmlStableDiffusionVideoWorkflowPreset preset) {
	switch (preset) {
	case ofxGgmlStableDiffusionVideoWorkflowPreset::FastPreview: return "FastPreview";
	case ofxGgmlStableDiffusionVideoWorkflowPreset::LowVram: return "LowVram";
	case ofxGgmlStableDiffusionVideoWorkflowPreset::Balanced: return "Balanced";
	case ofxGgmlStableDiffusionVideoWorkflowPreset::Quality: return "Quality";
	case ofxGgmlStableDiffusionVideoWorkflowPreset::BatchStoryboard: return "BatchStoryboard";
	default:
		return "Balanced";
	}
}

inline void ofxGgmlStableDiffusionApplyVideoWorkflowPreset(
	...
	switch (preset) {
	case ofxGgmlStableDiffusionVideoWorkflowPreset::FastPreview:
		...
		break;
	case ofxGgmlStableDiffusionVideoWorkflowPreset::LowVram:
		...
		break;
	case ofxGgmlStableDiffusionVideoWorkflowPreset::Balanced:
		...
		break;
	case ofxGgmlStableDiffusionVideoWorkflowPreset::Quality:
		...
		break;
	case ofxGgmlStableDiffusionVideoWorkflowPreset::BatchStoryboard:
...
inline ofxGgmlStableDiffusionVideoPromptValidation ofxGgmlStableDiffusionValidateVideoPromptWorkflow(
	const ofxGgmlStableDiffusionVideoRequest & request) {
	ofxGgmlStableDiffusionVideoPromptValidation validation;
...
inline ofJson ofxGgmlStableDiffusionBuildVideoRenderManifest(
	const ofxGgmlStableDiffusionVideoRequest & request,
	const ofxGgmlStableDiffusionVideoClip & clip,
	ofxGgmlStableDiffusionVideoWorkflowPreset preset,
	const std::string & outputDirectory = {},
	const std::string & metadataPath = {}) {
	ofJson root;
	root["preset"] = ofxGgmlStableDiffusionVideoWorkflowPresetLabel(preset);
	...
	root["mode"] = ofxGgmlStableDiffusionVideoModeLabel(request.mode);
	...
	const auto validation = ofxGgmlStableDiffusionValidateVideoPromptWorkflow(request);
...
inline bool ofxGgmlStableDiffusionSaveVideoRenderManifest(
	...
	return ofSavePrettyJson(
		path,
		ofxGgmlStableDiffusionBuildVideoRenderManifest(
			request,
			clip,
			preset,
			outputDirectory,
