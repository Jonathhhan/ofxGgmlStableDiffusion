...
#include "ofxGgmlStableDiffusionLongVideoManifest.h"
...
namespace ofxGgmlStableDiffusionLongVideoWorkflow {

inline const char* presetLabel(ofxGgmlStableDiffusionLongVideoPreset preset) {
	switch (preset) {
	case ofxGgmlStableDiffusionLongVideoPreset::FastPreview: return "FastPreview";
	case ofxGgmlStableDiffusionLongVideoPreset::LowVram: return "LowVram";
	case ofxGgmlStableDiffusionLongVideoPreset::Balanced: return "Balanced";
	case ofxGgmlStableDiffusionLongVideoPreset::Quality: return "Quality";
	case ofxGgmlStableDiffusionLongVideoPreset::BatchStoryboard: return "BatchStoryboard";
	default:
		return "Balanced";
	}
}
...
inline void applyPreset(
	...
	switch (preset) {
	case ofxGgmlStableDiffusionLongVideoPreset::FastPreview:
		...
		break;
	case ofxGgmlStableDiffusionLongVideoPreset::LowVram:
		...
		break;
	case ofxGgmlStableDiffusionLongVideoPreset::Balanced:
		...
		break;
	case ofxGgmlStableDiffusionLongVideoPreset::Quality:
		...
		break;
	case ofxGgmlStableDiffusionLongVideoPreset::BatchStoryboard:
...
inline ofxGgmlStableDiffusionLongVideoValidation validate(
	const ofxGgmlStableDiffusionLongVideoManifest& manifest) {
	ofxGgmlStableDiffusionLongVideoValidation validation;
...
inline ofxGgmlStableDiffusionVideoRequest buildChunkRequest(
	const ofxGgmlStableDiffusionLongVideoManifest& manifest,
	const ofxGgmlStableDiffusionLongVideoChunk& chunk) {
	ofxGgmlStableDiffusionVideoRequest request;
...
inline std::string buildPlaylistManifestJson(
	const ofxGgmlStableDiffusionLongVideoManifest& manifest,
	const std::vector<ofxGgmlStableDiffusionLongVideoChunkResult>& chunkResults) {
	std::ostringstream output;
	output << "{\n";
	output << "  \"project_name\": \"" << jsonEscape(manifest.projectName) << "\",\n";
	output << "  \"playlist\": [\n";
