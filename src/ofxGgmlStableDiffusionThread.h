...
class ofxGgmlStableDiffusionThread : public ofThread {
public:
	struct OwnedImage {
	...
	struct ContextTaskData {
		...
		ofxGgmlStableDiffusionUpscalerSettings upscalerSettings;
	};

	struct ImageTaskData {
		ofxGgmlStableDiffusionTask task = ofxGgmlStableDiffusionTask::TextToImage;
		ofxGgmlStableDiffusionContextSettings contextSettings;
		ofxGgmlStableDiffusionUpscalerSettings upscalerSettings;
		...
		std::function<std::vector<ofxGgmlStableDiffusionImageScore>(
			const ofxGgmlStableDiffusionImageRequest& request,
			const std::vector<ofxGgmlStableDiffusionImageFrame>& images)> imageRankCallback;
	...
	struct VideoTaskData {
		ofxGgmlStableDiffusionTask task = ofxGgmlStableDiffusionTask::ImageToVideo;
		ofxGgmlStableDiffusionContextSettings contextSettings;
		ofxGgmlStableDiffusionUpscalerSettings upscalerSettings;
	...
	~ofxGgmlStableDiffusionThread() override;
	void clearContexts();
