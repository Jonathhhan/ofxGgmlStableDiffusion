...
class ofApp : public ofBaseApp {
	public:
		...
		void allocate();
		void applySelectedImageMode(ofxGgmlStableDiffusionImageMode mode);
		...
		void syncAutomaticMediaMode(const ofxGgmlStableDiffusionCapabilities& capabilities);
		...
		ofxGgmlStableDiffusionRealtimeVideoSettings buildCreativeLoopSettings() const;
		ofxGgmlStableDiffusionRealtimeVideoRequest buildCreativeLoopRequest() const;
		bool startCreativeLoop();
		void submitCreativeLoopPrompt();
		void drawCreativeLoopSection();
		ofxGgmlStableDiffusionContextSettings buildContextSettings() const;
		ofxGgmlStableDiffusionVideoRequest buildVideoRequest() const;
		...
		ofxGgmlStableDiffusionImageMode imageModeEnum = ofxGgmlStableDiffusionImageMode::TextToImage;
		ofxGgmlStableDiffusionImageSelectionMode selectionModeEnum =
		...
		ofxGgmlStableDiffusionInterpolationMode interpolationModeEnum =
			ofxGgmlStableDiffusionInterpolationMode::Smooth;
		ofxGgmlStableDiffusionImageParameterProfile imageParameterProfile;
		ofxGgmlStableDiffusionVideoParameterProfile videoParameterProfile;
		sd_image_t endInputImage = {0, 0, 0, nullptr};
		sd_image_t maskGuideInput = {0, 0, 0, nullptr};
		std::vector<sd_image_t> videoControlFrames;
		ofxGgmlStableDiffusionHoloscanBridge holoscanBridge;
		...
		ofxGgmlStableDiffusionRealtimeVideoSession creativeLoop;
		ofTexture creativeLoopTexture;
		ofxGgmlStableDiffusionRealtimeVideoSettings creativeLoopSettings;
		...
		ofxGgmlStableDiffusionRealtimeVideoQuality creativeLoopLastQuality =
